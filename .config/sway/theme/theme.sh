...
apply_sway() {
	...
	sed -i ${DIR}/sway-theme \
		...
		-e "s/set \$sway_cl_col_in.*/set \$sway_cl_col_in $color2/g" \
		-e "s/set \$sway_cl_col_afoc.*/set \$sway_cl_col_afoc $accent/g" \
		-e "s/set \$sway_cl_col_ifoc.*/set \$sway_cl_col_ifoc $color4/g" \
		-e "s/set \$sway_cl_col_ufoc.*/set \$sway_cl_col_ufoc $altbackground/g" \
		-e "s/set \$sway_cl_col_urgt.*/set \$sway_cl_col_urgt $color5/g" \
